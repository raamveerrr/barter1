...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gradient-to-r from-indigo-700/80 via-fuchsia-600/70 to-amber-500/60 backdrop-blur supports-[backdrop-filter]:bg-opacity-60">
      {({ open }) => (
        <>
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      ...
                      >
                        ...
                        <span className="absolute inset-x-2 -bottom-1 h-px bg-white/40 opacity-0 group-hover:opacity-100 transition-opacity" />
                      </Link>
                    ))}
                  </div>
                </div>
